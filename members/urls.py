...
urlpatterns = [
    ...
    # Search APIs
    path('api/search/image/', search_views.search_products_by_image, name='search_products_by_image'),
    path('api/search/text-image/', search_views.search_products_by_text_image, name='search_products_by_text_image'),
    path('api/debug/models/', search_views.debug_models, name='debug_models'),
